...
public class DataConfig {
    ...
    public LocalSessionFactoryBean sessionFactory() {
        ...
        // Allows a package to be passed in that contains the JPA annotated entity classes
        sessionFactory.setPackagesToScan(env.getProperty("giflib.entities.package"));
